...
import { PublicacionInmuebleDeleteDialog } from './publicacion-inmueble-delete-dialog';

describe('PublicacionInmueble Management Delete Component', () => {
  let comp: PublicacionInmuebleDeleteDialog;
  let fixture: ComponentFixture<PublicacionInmuebleDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PublicacionInmuebleDeleteDialog);
