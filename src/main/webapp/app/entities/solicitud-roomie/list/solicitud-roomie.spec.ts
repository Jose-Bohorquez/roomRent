...
import { sampleWithRequiredData } from '../solicitud-roomie.test-samples';

import { SolicitudRoomie } from './solicitud-roomie';

vitest.useFakeTimers();

describe('SolicitudRoomie Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: SolicitudRoomie;
  let fixture: ComponentFixture<SolicitudRoomie>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SolicitudRoomie);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '7323fa9a-b571-4220-b2ec-5732900ce29a' }], {
    ...
    expect(comp.solicitudRoomies()[0]).toEqual(expect.objectContaining({ id: '7323fa9a-b571-4220-b2ec-5732900ce29a' }));
  });
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: '7323fa9a-b571-4220-b2ec-5732900ce29a' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    expect(comp.solicitudRoomies()).toEqual([]);

    // WHEN - second load should still work
    comp.load();
    TestBed.tick();
    const successReq = httpMock.expectOne({ method: 'GET' });
    successReq.flush([{ id: '7323fa9a-b571-4220-b2ec-5732900ce29a' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  describe('trackId', () => {
    it('should forward to solicitudRoomieService', () => {
      const entity = { id: '7323fa9a-b571-4220-b2ec-5732900ce29a' };
      vitest.spyOn(service, 'getSolicitudRoomieIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSolicitudRoomieIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.solicitudRoomiesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
