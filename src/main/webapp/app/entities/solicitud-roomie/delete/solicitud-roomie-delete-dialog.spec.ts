...
import { SolicitudRoomieDeleteDialog } from './solicitud-roomie-delete-dialog';

describe('SolicitudRoomie Management Delete Component', () => {
  let comp: SolicitudRoomieDeleteDialog;
  let fixture: ComponentFixture<SolicitudRoomieDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SolicitudRoomieDeleteDialog);
