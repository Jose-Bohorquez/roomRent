...
import { MultimediaInmuebleDeleteDialog } from './multimedia-inmueble-delete-dialog';

describe('MultimediaInmueble Management Delete Component', () => {
  let comp: MultimediaInmuebleDeleteDialog;
  let fixture: ComponentFixture<MultimediaInmuebleDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MultimediaInmuebleDeleteDialog);
