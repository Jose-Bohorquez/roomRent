...
@Component({
  ...
  templateUrl: './solicitud-arriendo-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class SolicitudArriendoDeleteDialog {
  solicitudArriendo?: ISolicitudArriendo;
  ...
  confirmDelete(id: string): void {
    this.solicitudArriendoService.delete(id).subscribe(() => {
