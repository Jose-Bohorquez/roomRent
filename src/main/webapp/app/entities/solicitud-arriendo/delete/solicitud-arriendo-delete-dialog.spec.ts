...
import { SolicitudArriendoDeleteDialog } from './solicitud-arriendo-delete-dialog';

describe('SolicitudArriendo Management Delete Component', () => {
  let comp: SolicitudArriendoDeleteDialog;
  let fixture: ComponentFixture<SolicitudArriendoDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SolicitudArriendoDeleteDialog);
