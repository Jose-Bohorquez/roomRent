...
import { PerfilUsuarioDeleteDialog } from './perfil-usuario-delete-dialog';

describe('PerfilUsuario Management Delete Component', () => {
  let comp: PerfilUsuarioDeleteDialog;
  let fixture: ComponentFixture<PerfilUsuarioDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PerfilUsuarioDeleteDialog);
