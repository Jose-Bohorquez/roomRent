...
import { ContratoArriendoDeleteDialog } from './contrato-arriendo-delete-dialog';

describe('ContratoArriendo Management Delete Component', () => {
  let comp: ContratoArriendoDeleteDialog;
  let fixture: ComponentFixture<ContratoArriendoDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ContratoArriendoDeleteDialog);
