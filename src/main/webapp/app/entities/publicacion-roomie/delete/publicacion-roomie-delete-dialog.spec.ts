...
import { PublicacionRoomieDeleteDialog } from './publicacion-roomie-delete-dialog';

describe('PublicacionRoomie Management Delete Component', () => {
  let comp: PublicacionRoomieDeleteDialog;
  let fixture: ComponentFixture<PublicacionRoomieDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PublicacionRoomieDeleteDialog);
