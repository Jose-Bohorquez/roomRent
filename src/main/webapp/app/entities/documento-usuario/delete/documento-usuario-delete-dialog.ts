...
@Component({
  ...
  templateUrl: './documento-usuario-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class DocumentoUsuarioDeleteDialog {
  documentoUsuario?: IDocumentoUsuario;
  ...
  confirmDelete(id: string): void {
    this.documentoUsuarioService.delete(id).subscribe(() => {
