...
import { DocumentoUsuarioDeleteDialog } from './documento-usuario-delete-dialog';

describe('DocumentoUsuario Management Delete Component', () => {
  let comp: DocumentoUsuarioDeleteDialog;
  let fixture: ComponentFixture<DocumentoUsuarioDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentoUsuarioDeleteDialog);
