      ...
      <header className="sticky top-0 z-30 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-sm
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-stone-800 dark:text-white">Reportes</span>
          </div>
          <div className="flex items-center gap-3">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        <div className="text-center py-20">
          ...
          <p className="text-stone-500 dark:text-zinc-400 text-sm max-w-sm mx-auto">
            Aquí encontrarás reportes sobre el estado de tus arriendos y actividad reciente.
